...
function border_sliding(){
  ...
  percentage_tl.fromTo(percentage[0],2,{color:"hsla(180,100%,50%,0.8)",y:15},{delay:1.85,opacity:1,color:"#FFE4C4 ",y:0})
  percentage_tl.fromTo(percentage[1],2,{color:"hsla(180,100%,50%,0.9)",y:15},{opacity:1,color:"#FFE4C4 ",y:0},"-=1.65")
  percentage_tl.fromTo(percentage[2],2,{color:"hsla(180,100%,50%,0.9)",y:15},{opacity:1,color:"#FFE4C4 ",y:0},"-=1.65")
  percentage_tl.fromTo(percentage[3],2,{color:"hsla(180,100%,50%,0.7)",y:15},{opacity:1,color:"#FFE4C4 ",y:0},"-=1.65")
  percentage_tl.fromTo(percentage[4],2,{color:"hsla(180,100%,50%,1)",y:15},{opacity:1,color:"#FFE4C4 ",y:0},"-=1.65")
  percentage_tl.fromTo(percentage[5],2,{color:"hsla(180,100%,50%,1)",y:15},{opacity:1,color:"#FFE4C4 ",y:0},"-=1.65")
  percentage_tl.fromTo(percentage[6],2,{color:"hsla(180,100%,50%,0.4)",y:15},{opacity:1,color:"#FFE4C4 ",y:0},"-=1.65")
}
